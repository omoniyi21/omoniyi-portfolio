  ...
  return <section className="personal-effects" id="personal-effects" aria-labelledby="personal-effects-title">
    ...
    <div className="personal-effects__spread" aria-label="A collection of current interests and creative fuel">
      ...
      <div className="personal-effects__glass-content">
        ...
        <Paper className="effect-paper--movie" src={MovieTicket} label="Current movie obsession: The End of Oak Street"><p className="paper-eyebrow">Current movie obsession</p><h3>I LOVE<br />BOOSTERS</h3><p>the movie that lives<br />in my head rent free.</p><small>Theater 02 · Row D · Seat 07</small></Paper>
    ...
    <section className="personal-effects__mobile-card" aria-label="Current creative fuel">
      ...
      <div className="personal-effects__mobile-grid">
        ...
        <article><span>Current movie obsession</span><h3>The End of Oak Street</h3><p>The movie that lives in my head rent free.</p></article>
